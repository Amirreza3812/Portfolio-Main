    ...
    <header className="py-2 px-2 fixed top-0 left-0 w-full z-40">
      <div className="mx-auto max-w-xl">
        <nav className="backdrop-filter backdrop-blur-lg bg-white bg-opacity-40 rounded-xl flex items-center justify-between shadow-md">
          ...
          {/* منوی سمت چپ (لینک‌ها) */}
          <div className="flex gap-x-1 px-1 py-1 sm:gap-x-3 sm:px-5 sm:py-2">
            <NavLink
              to="/"
              className={({ isActive }) =>
                isActive
          ...
          {/* سمت راست (Hire Me + LanguageSwitcher) */}
          <div className="justify-center flex p-2 items-center">
            
            {/* دکمه Hire Me → فقط از md به بالا */}
            <a
            ...
            >
              ...
              >
                ...
                <span className="hidden md:block">{t("workTogether.hire")}</span>
              </button>
            </a>
